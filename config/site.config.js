...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'index@account5.onmicrosoft.com',
  ...
  footer:
    'Powered by <a href="chjina.com" target="_blank" rel="noopener noreferrer">
